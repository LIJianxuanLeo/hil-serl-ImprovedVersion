...
- **[`../docs/02-改进记录/CHANGES.md`](../docs/02-改进记录/CHANGES.md)** — 所有修改项的技术分析（含 §8b：V2.0 → V2.1 hybrid reward 重构）
- **[`../docs/03-部署与训练指南/实验合作内容.md`](../docs/03-部署与训练指南/实验合作内容.md)** — A100 协作训练剧本（含 wandb 设置）
